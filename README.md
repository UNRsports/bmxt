...
https://github.com/user-attachments/assets/42b68190-7a7a-4507-b09d-c632dbd52c84
...
- `lib/features/tab-picker/` — タブピッカー機能の集約エントリ（UI/行データ）
- `tab-picker-overlay.tsx` — タブピッカー UI 本体
