/**
 * EN: Hard caps for in-memory grep / page scans (no persistence; limits memory + terminal spam).
...
/** EN: Max http(s) tabs scanned for grep -page (discarded tabs skipped elsewhere). JA: grep -page で走査するタブ数上限。 */
