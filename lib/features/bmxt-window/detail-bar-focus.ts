...
/** EN: Ctrl+C on the detail bar — exit browse column or disarm nav. */
export function isCtrlCloseDetailBarKey(
...
/** @deprecated Use `isCtrlCloseDetailBarKey`. */
export const isCtrlCloseBrowseKey = isCtrlCloseDetailBarKey
